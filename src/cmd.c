...
const char *levltyp[MAX_TYPE + 2] = {
    ...
    "mystery item", /* TNNT - robotfindskitten patch */
...
struct ext_func_tab extcmdlist[] = {
    ...
    { '\0',   "achievements", "show TNNT complete or unfinished achievements",
              dotnntachievements, IFBURIED | AUTOCOMPLETE, NULL },
    ...
    { '\0',   "snacks", "show foods eaten so far (TNNT)",
              doshowfoodseaten, IFBURIED | AUTOCOMPLETE, NULL },
    { '\0',   "species", "show species you have killed at least 1 of (TNNT)",
              dotnntspecies, IFBURIED | AUTOCOMPLETE, NULL },
    ...
    { '\0',   "tnntdebug", "display TNNT debug information",
              ...
              IFBURIED, NULL },
#else
              IFBURIED | WIZMODECMD, NULL },
#endif
    /* this one is for regular play */
    { '\0',   "tnntstats", "display TNNT statistics in-game",
              dotnntstats, IFBURIED | AUTOCOMPLETE, NULL },
