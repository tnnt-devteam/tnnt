...
struct tnnt_achvmt_data tnnt_achievements[NUM_TNNT_ACHIEVEMENTS] = {
  ...
  {"Friends Not Food", "Reach your quest leader with vegetarian conduct intact"},
  {"Animal Rights Activist", "Reach your quest leader with vegan conduct intact"},
  {"Anti Gulp", "Reach your quest leader with foodless conduct intact"},
  {"No Help from Above", "Reach your quest leader with atheist conduct intact"},
  {"Wax On Wax Off", "Reach your quest leader with weaponless conduct intact"},
  {"Thou Shalt Not Kill", "Reach your quest leader with pacifist conduct intact"},
  {"Me No Do Words Good", "Reach your quest leader with illiterate conduct intact"},
  {"Lost My Transmutation License", "Reach your quest leader with polypileless conduct intact"},
  {"True to Form", "Reach your quest leader with polyselfless conduct intact"},
  {"Self Sufficient", "Reach your quest leader with wishless conduct intact"},
  {"Leave the Artifacts to the Gods", "Reach your quest leader with artifact wishless conduct intact"},
  {"No Help From The Floor", "Reach your quest leader with Elberethless conduct intact"},
  {"Feeling Your Way", "Reach your quest leader with zen (permablind) conduct intact"},
  {"Going Commando", "Reach your quest leader with nudist conduct intact"},
  {"Make Love, Not War", "Reach your quest leader with genocideless conduct intact"},
