...
struct tnnt_achvmt_data tnnt_achievements[NUM_TNNT_ACHIEVEMENTS] = {
  ...
  {"??? UNKNOWN TITLE 1 ???", "Resurrect the Wizard of Yendor"},
  {"??? UNKNOWN TITLE 2 ???", "Kill a Rider permanently"},
  ...
  {"LEARN THE ALPHABET", "Kill a monster of each species from A to Z (except I)"},
  ...
  {"Hammer of the Gods", "Kill a monster by throwing Mjollnir at them and having it return to your hand"},
