...
ACH("Nine for Mortal Men Doomed to Die ... Again", "Kill all nine Nazgul",
    KILLED_9_NAZGUL),
...
ACH("Master of the Four Elementals",
    "Kill at least 4 elementals on their respective home planes",
...
ACH("Quadruple Kill", "Kill 4 monsters with a single volley of missiles",
    MULTISHOT_4_KILLED),
...
ACH("Hyperliterate", "Read every readable item in the game",
    READ_ALL_READABLE),
...
ACH("Reincarnation Cancelled", "Tin a troll or get its corpse to rot",
...
ACH("Right Back at Ya", "Hit an enemy with a thrown boomerang",
    HIT_WITH_BOOMERANG),
...
ACH("Near Death Experience",
    "#chat to Death while carrying a Terry Pratchett novel", TALKED_TO_DEATH),
ACH("Prize Inside!",
...
ACH("Panacea", "Neutralize a harmful potion with a unicorn horn",
    NEUTRALIZED_POTION),
ACH("Croesus Competitor", "Finish a game carrying at least 50000 gold",
    FINISHED_WITH_50000),
ACH("Croesus Buyout", "Finish a game carrying at least 100000 gold",
    FINISHED_WITH_100000),
...
ACH("You're About To Die, You Scrub",
    ...
    ABOUT_TO_DIE),
ACH("Extinctionist Lite", "Genocide 20 or more monster species",
    GENOCIDED_20_SPECIES),
...
ACH("This One Goes To +8", "Successfully enchant a weapon to +8 or higher",
    ENCHANT_WEP_TO_8),
ACH("Sword Plus Plus", "Successfully increase the enchantment on your weapon",
    ENCHANT_WEAPON),
ACH("Blasters' Handbook", "Blow up a boulder with a land mine",
    BLEW_UP_BOULDER),
ACH("Po-Loew-morph", "Create a golem from a pile of objects",
    POLY_MADE_GOLEM),
