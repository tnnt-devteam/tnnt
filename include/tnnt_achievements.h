...
/* Style guidelines:
 * 1. Every word in an achievement's name should be capitalized, even words like
 *    "a" and "the". Puns, references, rhymes, etc are encouraged. The only
...
ACH("Quadruple Kill",
    ...
    MULTISHOT_4_KILLED),
ACH("Dishing Out Death", "Kill a member of 25 different monster species",
    KILLED_25_SPECIES),
...
ACH("Michelin Guide", "Identify both sources of food detection",
    ID_DETECT_FOOD),
ACH("Hoard of the Rings", "Identify all rings", IDENTIFIED_ALL_RINGS),
...
ACH("Helm Hoarder", "Identify all randomized helms", IDENTIFIED_ALL_HELMS),
...
ACH("Death Isn't So Cheap", "Receive the Quest with survivor conduct intact",
    PARTIAL_SURVIVOR),
ACH("Open Carry", "Receive the Quest with containerless conduct intact",
    PARTIAL_CONTAINERLESS),
ACH("Beyond The Wand", "Receive the Quest with zapless conduct intact",
    PARTIAL_ZAPLESS),
ACH("No Drink For Me, Please",
    "Receive the Quest with potionless conduct intact", PARTIAL_POTIONLESS),
...
ACH("Team Ant Headquarters", "Enter an anthole", ENTERED_ANTHOLE),
...
ACH("The Last Chance Outpost", "Visit a shop at or below level 20",
    VISITED_DEEP_SHOP),
ACH("If We Don't Have It, You Don't Need It", "Enter a general store",
    ENTERED_GENERAL_STORE),
ACH("Food Glorious Food", "Enter a delicatessen", ENTERED_DELICATESSEN),
ACH("Single-Use Reading Material", "Enter a scroll shop", ENTERED_SCROLL_SHOP),
ACH("Nearest Thing To A Library", "Enter a book shop", ENTERED_BOOK_SHOP),
ACH("What's Your Poison?", "Enter a potion shop", ENTERED_POTION_SHOP),
ACH("He Protec", "Enter an armor shop", ENTERED_ARMOR_SHOP),
ACH("But He Also Attac", "Enter a weapon shop", ENTERED_WEAPON_SHOP),
ACH("The Right Tool For The Job", "Enter a tool shop", ENTERED_TOOL_SHOP),
ACH("Vegan Outfitters", "Enter a health food shop", ENTERED_HEALTH_FOOD_SHOP),
ACH("Zap Happy", "Enter a wand shop", ENTERED_WAND_SHOP),
ACH("A Real Gem Of A Shop", "Enter a jewelers", ENTERED_JEWELRY_SHOP),
...
ACH("Androcles' Lion", "Pacify a monster by freeing it from a trap",
    PACIFIED_BY_UNTRAPPING),
ACH("All Just A Misunderstanding", "Pacify an angry shopkeeper",
    PACIFIED_SHOPKEEPER),
...
ACH("Say Hello To My Evil Friend",
    ...
    GATED_IN_DEMON_LORD),
ACH("Boss Rush",
    "Get every demon lord and prince active and hostile on the same level at the same time",
    FACED_ALL_DEMON_LORDS_AT_ONCE),
...
ACH("Plane Sailing",
    ...
    SPEEDRAN_PLANES),
ACH("The Great Heist", "Plunder every vault in the Dungeons of Doom",
    ENTERED_ALL_VAULTS),
...
"Dracarys" - Kill a monster by getting your dragon steed (or just pet) to
breathe at it.
*/
