...
/* P:pfx, sec, ln, opt_*, setwhere?, negateok?, valok?, dupok?, hndlr? Alias,
 ...
 /* NHOPTC(gender) -- moved to top */
    ...
    NHOPTB(guicolor, Advanced, 0, opt_out, set_in_game,
           ...
           "use color for UI")
    NHOPTB(hallucinating, Advanced, 0, opt_in, set_in_config,
           Off, Yes, No, No, NoAlias, &u.uroleplay.hallu, Term_False,
           "your character is permanently hallucinating")
 ...
 /* NHOPTC(race) -- moved to top */
    ...
    NHOPTC(realtime, Advanced, 1, opt_in, set_in_game,
           Yes, Yes, No, No, NoAlias,
           "show realtime on status line")
    NHOPTC(realtime_format, Advanced, 1, opt_in, set_in_game,
           Yes, Yes, No, No, NoAlias,
           "format of realtime on status line")
#endif
 ...
 /* NHOPTC(role) -- moved to top */
    ...
    NHOPTB(tnnt_notify, General, 0, opt_out, set_in_game,
           On, Yes, No, No, NoAlias, &flags.notify_achievements, Term_False,
           "show a message when you earn a TNNT achievement")
