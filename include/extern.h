...
extern void add_deathmatch_arena_region(void); /* TNNT */
...
extern int dotnntdebug(void);
extern int dotnntstats(void);
extern int show_tnnt_stats(boolean);
extern int dotnntachievements(void);
...
extern void delete_swap_chest_contents(struct obj *) NONNULLARG1;
extern const char *swapobj_donor_name(struct obj *) NONNULLARG1;
extern void credit_swapobj_donor(struct obj *) NONNULLARG1;
extern boolean swap_chest_quan_too_high(struct obj *) NONNULLARG1;
extern boolean swap_chest_eligible(struct obj *) NONNULLARG1;
extern void maybe_place_dungeons_swapchest(void);
extern void write_npc_data(void);
extern struct monst* create_tnnt_npc(coordxy, coordxy);
extern void shut_the_front_door(void);
...
extern void initialize_prev_game_achievements(void);
extern void write_prev_ach_file(void);
extern boolean tnnt_is_achieved(short);
extern void tnnt_achieve(short);
extern void tnnt_announce_achievements(void);
extern boolean tnnt_is_watch_present(void);
extern boolean In_dungeons_of_doom(d_level *) NONNULLARG1;
extern boolean Is_minetown(d_level *) NONNULLARG1;
extern void tnnt_add_untrap(unsigned int);
extern void tnnt_door_resists(coordxy, coordxy);
...
extern void tnnt_read(int);
extern void tnnt_record_altar(unsigned int);
extern void tnnt_check_castle_rush(void);
extern void tnnt_do_quest_achievements(void);
