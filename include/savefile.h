...
/* TNNT additions */
extern void sfo_tnnt_globals_t(NHFILE *, struct tnnt_globals_t *, const char *);
/* end TNNT */
...
/* TNNT additions */
extern void sfi_tnnt_globals_t(NHFILE *, struct tnnt_globals_t *, const char *);
/* end TNNT */
...
/* TNNT additions */
#define Sfo_tnnt_globals_t(a,b,c) sfo_tnnt_globals_t(a, b, c)
/* end TNNT */
...
/* TNNT additions */
#define Sfi_tnnt_globals_t(a,b,c) sfi_tnnt_globals_t(a, b, c)
/* end TNNT */
...
#define sfo(nhfp, dt, tag)                     \
  _Generic( (dt),                              \
    ...
    struct tnnt_globals_t * : sfo_tnnt_globals_t, \
...
#define sfi(nhfp, dt, tag)                     \
  _Generic( (dt),                              \
    ...
    struct tnnt_globals_t * : sfi_tnnt_globals_t, \
...
/* TNNT additions */
#define Sfo_tnnt_globals_t(a,b,c) sfo(a, b, c)
/* end TNNT */
...
/* TNNT additions */
#define Sfi_tnnt_globals_t(a,b,c) sfi(a, b, c)
/* end TNNT */
