...
CONTAINER("ice box",         NoDes, 1, 0, 0,  5, 900,  42, PLASTIC, CLR_WHITE,
                                                                ICE_BOX),
CONTAINER("swap chest",     "mysterious sapient pearwood container",
                                    0, 1, 0, 0, 6000, 16000, WOOD, CLR_GREEN,
                                                                SWAP_CHEST),
...
SCROLL("missing code", "PLZ RETURN TO DEVTEAM",
                                    0,   0,   0, SCR_MISSING_CODE),
