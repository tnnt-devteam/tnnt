...
struct nhdatatypes_t readtagstypes[] = {
    ...
    /* TNNT additions */
    { NHTYPE_COMPLEX, (char *) "tnnt_globals_t", sizeof(struct tnnt_globals_t) },
    /* end TNNT */
                    ...
                    if (isptr && !strcmp(fnbuf, readtagstypes[k].dtype)) {
                        Strcpy(altbuf, "genericptr");
                               ...
                               && (!strcmp(t->ptr, "struct permonst *")
                                   ...
                                   /* TNNT additions */
                                   || !strcmp(t->ptr, "struct tnnt_globals_t *")
                                   /* end TNNT */
...
const struct already_in_sfbase already[] = {
    ...
    /* TNNT additions */
    { NHTYPE_COMPLEX, "Sfi_tnnt_globals_t", "Sfi_x_tnnt_globals_t" },
    /* end TNNT */
    ...
    /* TNNT additions */
    { NHTYPE_COMPLEX, "Sfo_tnnt_globals_t", "Sfo_x_tnnt_globals_t" },
    /* end TNNT */
...
struct nh_classification nhdatatypes[] = {
    ...
    /* TNNT additions */
    { 0, NHTYPE_COMPLEX, "sfi_tnnt_globals_t", "sfi_tnnt_globals_t" },
    /* end TNNT */
    ...
    /* TNNT additions */
    { 0, NHTYPE_COMPLEX, "sfo_tnnt_globals_t", "sfo_tnnt_globals_t" },
    /* end TNNT */
