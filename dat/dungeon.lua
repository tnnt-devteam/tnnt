...
--          bonetag = "E"
   ...
   -- at time of 5.0.0 merge, TNNT branches moved to be after all vanilla
   -- branches so that dungeon numbers remain consistent.
   -- None of them have bonetags because they are all one-level branches and are
   -- ineligible to leave bones.
   {
      name = "DevTeam Office",
      base = 1,
      flags = { "mazelike" },
