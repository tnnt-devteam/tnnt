...
You couldn't quite make out that last message.]],
      ...
      -- TNNT common messages start here --
      devteam_givenquest = {
         output = "text",
         text = [[
"Ah, you must be a hero questing for the Amulet of Yendor.  May I ask
you to listen for a moment?  We are in dire need of some assistance.
...
return our missing code to us, I can promise you a fine reward."]],
         synopsis = "[You are asked to search the Dungeons of Doom for the missing scrolls.]",
      },
      devteam_finishquest = {
         output = "text",
         text = [[
"Thank you, %p!  You have done the DevTeam a great
service.  We will certainly be able to release the next version before
long.  In exchange, allow me to present you with this T-shirt, which you
may find helpful in your quest."]],
         synopsis = "[You have recovered all the missing code, and are given a T-shirt.]",
      },
      devteam_badfinish = {
         output = "text",
         text = [[
Mike Stephenson looks at you frostily.
    ...
    "Thank you... I suppose.  You have done us a service.  But I think
    you have done us a far greater disservice as well.  Now that our
    business is concluded, kindly remove yourself from our office."]],
         synopsis = "[Your sins outweigh your good deed; leave the office.]",
      },
      devteam_endofgame = {
         output = "pline",
         text = [[
...
The remaining members look at you reproachfully, and then vanish from the world.]],
      ...
      devteam_aoy_reaction = {
         output = "text",
         text = [[
Mike Stephenson looks at you with faint distaste.

    "The Amulet of Yendor?  You're on your own with that mess.  We came
    here to locate our missing code, not to step in and interfere with
    the careers of individual heroes."

He shifts uncomfortably from side to side.

    "And frankly, it makes us all a little nervous to be around it.
    Now get out of here, and take the Amulet with you -- you're late
    enough for the Planes as it is."]],
         synopsis = "[You are encouraged to hurry up and take the Amulet to its destination.]",
      },
   },
   Arc = {
      assignquest = {
