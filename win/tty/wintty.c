...
static const enum statusfields
    ...
    { BL_LEVELDESC, BL_GOLD, BL_HP, BL_HPMAX, BL_ENE, BL_ENEMAX,
      BL_AC, BL_XP, BL_EXP, BL_HD, BL_TIME, BL_REALTIME, BL_HUNGER, BL_CAP,
    ...
    { BL_LEVELDESC, BL_TIME, BL_REALTIME, BL_CONDITION, BL_WEAPON, BL_ARMOR, BL_TERRAIN,
 ...
 *         BL_XP, BL_AC, BL_HD, BL_TIME, BL_REALTIME, BL_HUNGER, BL_HP, BL_HPMAX,
...
status_sanity_check(void)
{
    static const char *const idxtext[] = {
        ...
        "BL_TIME", "BL_REALTIME", "BL_HUNGER", "BL_HP", "BL_HPMAX",/* 16..20 */
