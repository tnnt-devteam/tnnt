...
{S_vbeam,    "vertical beam", "cmap 66"},
{S_hbeam,    "horizontal beam", "cmap 67"},
{S_lslant,   "left slant beam", "cmap 68"},
{S_rslant,   "right slant beam", "cmap 69"},
{S_digbeam,  "dig beam", "cmap 70"},
{S_flashbeam, "flash beam", "cmap 71"},
{S_boomleft, "boom left", "cmap 72"},
{S_boomright, "boom right", "cmap 73"},
{S_ss1,      "shield1", "cmap 74"},
{S_ss2,      "shield2", "cmap 75"},
{S_ss3,      "shield3", "cmap 76"},
{S_ss4,      "shield4", "cmap 77"},
{S_poisoncloud, "poison cloud", "poison cloud"},
{S_goodpos,  "valid position", "valid position"},
{S_sw_tl,    "swallow top left", "cmap 80"},
{S_sw_tc,    "swallow top center", "cmap 81"},
{S_sw_tr,    "swallow top right", "cmap 82"},
{S_sw_ml,    "swallow middle left", "cmap 83"},
{S_sw_mr,    "swallow middle right", "cmap 84"},
{S_sw_bl,    "swallow bottom left ", "cmap 85"},
{S_sw_bc,    "swallow bottom center", "cmap 86"},
{S_sw_br,    "swallow bottom right", "cmap 87"},
